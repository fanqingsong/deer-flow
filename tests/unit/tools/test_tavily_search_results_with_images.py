...
class TestTavilySearchResultsWithImages:
    ...
    def test_run_success(self, mock_print, search_tool, mock_api_wrapper, 
                        sample_raw_results, sample_cleaned_results):
    ...
    @pytest.mark.asyncio
    @patch('builtins.print')
    async def test_arun_success(self, mock_print, search_tool, mock_api_wrapper,
                               sample_raw_results, sample_cleaned_results):
    ...
    @patch('builtins.print')
    def test_run_with_run_manager(self, mock_print, search_tool, mock_api_wrapper,
                                 sample_raw_results, sample_cleaned_results):
    ...
    @pytest.mark.asyncio
    @patch('builtins.print')
    async def test_arun_with_run_manager(self, mock_print, search_tool, mock_api_wrapper,
                                        sample_raw_results, sample_cleaned_results):
    ...
    @patch('builtins.print')
    def test_print_output_format(self, mock_print, search_tool, mock_api_wrapper,
                                sample_raw_results, sample_cleaned_results):
    ...
    @pytest.mark.asyncio
    @patch('builtins.print')
    async def test_async_print_output_format(self, mock_print, search_tool, mock_api_wrapper,
                                           sample_raw_results, sample_cleaned_results):
